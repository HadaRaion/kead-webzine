  ...
  <main id="contents" class="post <?php echo $parentCategorySlug; if ($category === '공감 테마'): echo ' serif-post'; else: echo ''; endif; ?>">
    <section class="post__top">
      <div class="post__top__wrapper">
        <div class="post__top__title font-size-md ">
          <div class="post__top__title__parent-cat t-bold"><?php echo $parentCategory ?></div>
    ...
    <section class="post__contents p-top-large p-bottom-large ">
      <div class="container">
        ...
        <?php endif; ?>
        <h1 class="font-size-h2 t-center p-top"><?php the_title(); ?></h1>
        <div class="font-size-base p-top"><?php the_content(); ?></div>
      </div>
    </section>
