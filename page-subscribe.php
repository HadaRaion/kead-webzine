	...
	<div id="stb_subscribe" class="subscribe__form p-top">
      ...
      <fieldset class="stb_form_set text-xl p-top-xs">
        ...
        <div class="stb_form_msg_error" id="stb_email_error"></div>
            ...
            - 개인정보 수집 항목 : 성명, 이메일<br />
            - 개인정보 수집·이용 목적 : 장애인과 일터 웹진 구독 관리<br />
            - 개인정보의 보유 및 이용기간 : <span class="t-underline font-500">개인정보의 수집목적 달성시까지 보유, 고객 구독 취소 시 파기</span><br />
            - 개인정보 처리업무 위탁 내역(고지사항)<br />
            • 위탁 받는 자(수탁업체) : 오니트 주식회사<br />
            • 업무 내용: 장애인과 일터 웹진 운영<br />
            ※ 위의 개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다. 그러나 동의를 거부할 경우 웹진 구독 서비스 제공이 불가능합니다.
          </p>
			  </div>
