...
<main id="contents" class="main-page">
  <section class="banner">
    ...
    <?php get_template_part( 'template-parts/banner/content-banner', $thisMonth ); ?>
  </section>
    ...
    <div class="container">
      <div class="article part1 p-top-large">
        <div class="article__title">
          <div class="part-logo part-logo--1"
              ...
              <span class="post__thumbnail">
                ...
                <picture>
                  ...
                  <source media="(min-width: 960px)"
                    srcset="<?php the_post_thumbnail_url('kead-thumbnail-wide') ?>, <?php the_post_thumbnail_url('kead-thumbnail-wide-2x') ?> 2x" />
                  <img src="<?php the_post_thumbnail_url('kead-thumbnail') ?>" alt="<?php echo $alt_text ;?>" />
                </picture>
                <?php else: ?>
                <img
                  srcset="<?php the_post_thumbnail_url('kead-thumbnail') ?>, <?php the_post_thumbnail_url('kead-thumbnail-2x') ?> 2x"
                  src="<?php the_post_thumbnail_url('kead-thumbnail') ?>" alt="<?php echo $alt_text ;?>" />
                <?php endif; ?>
              </span>
      ...
      <div class="article part2 p-top-large">
        <div class="article__title">
          <div class="part-logo part-logo--2"
      ...
      <div class="article part3 p-top-large">
        <div class="article__title">
          <div class="part-logo part-logo--3"
            ...
            <a class="post" href="<?php the_permalink(); ?>" aria-label="<?php the_title(); ?> 기사보기">
              ...
              <span class="post__thumbnail">
                <img
                  ...
                  src="<?php the_post_thumbnail_url('kead-thumbnail-mini') ?>" alt="<?php echo $alt_text ;?>" />
              </span>
              <?php else: ?>
      ...
      <div class="article part4 p-top-large">
        <div class="article__title">
          <div class="part-logo part-logo--4"
        ...
        <?php get_template_part( 'template-parts/event/content-event', $thisMonth ); ?>
      </div>
    </div>
  </section>
</main>
